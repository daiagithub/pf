		...
		<div id="list-person" class="content scaffold-list" role="main">
			...
			<thead>
					<tr>
						...
						<g:sortableColumn property="area" title="${message(code: 'person.area.label', default: 'Area')}" />
						...
						<g:sortableColumn property="createdBy" title="${message(code: 'person.createdBy.label', default: 'Created By')}" />
				...
				<g:each in="${personInstanceList}" status="i" var="personInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td>${fieldValue(bean: personInstance, field: "area")}</td>
					
						<td>${fieldValue(bean: personInstance, field: "city")}</td>
					
						<td>${fieldValue(bean: personInstance, field: "country")}</td>
					
						<td>${fieldValue(bean: personInstance, field: "createdBy")}</td>
